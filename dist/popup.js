(function (global, factory) {
  ...
  var MaterialComponent$1 = /*#__PURE__*/Object.freeze({
    default: MaterialComponent
  });

  var _preact = ( preact_esm && preact ) || preact_esm;

  var require$$0 = ( MaterialComponent$1 && MaterialComponent ) || MaterialComponent$1;
  ...
  var _MaterialComponent = _interopRequireDefault(require$$0);
  ...
  function generateThemeClass(prop) {
    return 'mdc-theme--' + prop + '-bg';
  }

  var generateThemeClass$1 = /*#__PURE__*/Object.freeze({
    default: generateThemeClass
  });

  var require$$2 = ( generateThemeClass$1 && generateThemeClass ) || generateThemeClass$1;
  ...
  var _generateThemeClass = _interopRequireDefault(require$$2);
  ...
  class App extends Component {
      constructor(props) {
          ...
          chrome.extension.sendRequest({ ask: "getResult" }, (response) => {
              console.log(response.result);
          });
          console.log();
      }
      render(props, state) {
          return (h(Button, { ripple: true, raised: true }, "Flat button with ripple"));
      }
  }
